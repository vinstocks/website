...
const plans = [
  {
    ...
    features: [
      ...
      "Short-Mid term recommendations",
      "Chat support",
    ],
    popular: false,
  },
    ...
    <section id="pricing" className="py-24 relative">
      ...
      <div className="container mx-auto px-4">
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <a
                ...
                className={`w-full inline-flex items-center justify-center py-3 rounded-xl font-semibold transition-all ${
                  plan.popular
        ...
        <div className="max-w-md mx-auto">
          <div className="p-6 rounded-2xl border border-secondary/50 bg-gradient-to-b from-secondary/10 to-transparent">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full inline-flex items-center justify-center py-3 rounded-xl font-semibold bg-secondary text-white hover:opacity-90 transition-opacity"
            >
              Get Smart Portfolio
            </a>
          </div>
